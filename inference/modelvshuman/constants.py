...
PROJ_DIR = os.path.join(os.getcwd(), 'modelvshuman')
assert (
    PROJ_DIR != "None"
), "Please set the 'MODELVSHUMANDIR' environment variable as described in the README"
CODE_DIR = PROJ_DIR
...
NOISE_GENERALISATION_DATASETS = [
    "colour", "contrast", "high-pass", "low-pass", "phase-scrambling",
    "power-equalisation", "false-colour", "rotation", "eidolonI", "eidolonII",
    "eidolonIII", "uniform-noise"
]

TEXTURE_SHAPE_DATASETS = [
    "original", "greyscale", "texture", "edge", "silhouette", "cue-conflict"
]
...
PLOT_TYPE_TO_DATASET_MAPPING = {
    ...
    "accuracy":
    NOISE_GENERALISATION_DATASETS,
    "error-consistency-lineplot":
    NOISE_GENERALISATION_DATASETS,
    "shape-bias": ["cue-conflict"],
    "error-consistency":
    ["cue-conflict", "edge", "silhouette", "sketch", "stylized"],
    "benchmark-barplot":
    DEFAULT_DATASETS,
    "scatterplot":
    DEFAULT_DATASETS,
...
TORCHVISION_MODELS = [
    "alexnet", "vgg11_bn", "vgg13_bn", "vgg16_bn", "vgg19_bn", "squeezenet1_0",
    "squeezenet1_1", "densenet121", "densenet169", "densenet201",
    "inception_v3", "resnet18", "resnet34", "resnet50", "resnet101",
    "resnet152", "shufflenet_v2_x0_5", "mobilenet_v2", "resnext50_32x4d",
    "resnext101_32x8d", "wide_resnet50_2", "wide_resnet101_2", "mnasnet0_5",
    "mnasnet1_0"
]
...
ADV_ROBUST_MODELS = [
    "resnet50_l2_eps0", "resnet50_l2_eps0_5", "resnet50_l2_eps1",
...
BIT_M_MODELS = [
    "BiTM_resnetv2_50x1", "BiTM_resnetv2_50x3", "BiTM_resnetv2_101x1",
    "BiTM_resnetv2_101x3", "BiTM_resnetv2_152x2", "BiTM_resnetv2_152x4"
]

SWAG_MODELS = [
    "swag_regnety_16gf_in1k", "swag_regnety_32gf_in1k",
    "swag_regnety_128gf_in1k", "swag_vit_b16_in1k", "swag_vit_l16_in1k",
    "swag_vit_h14_in1k"
]
